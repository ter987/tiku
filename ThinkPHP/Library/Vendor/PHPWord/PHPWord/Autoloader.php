 ...
 */
namespace Vendor\PHPWord;
class PHPWord_Autoloader
{
	public static function Register() {
		return spl_autoload_register(array('Vendor\PHPWord\PHPWord_Autoloader','Load'));
	}
	...
	public static function Load($strObjectName) {
		...
		//PHPWORD_BASE_PATH
		$strObjectFilePath = THINK_LIBRARY_PATH . str_replace('_', '/', $strObjectName) . '.php';
		//echo $strObjectFilePath;exit;
